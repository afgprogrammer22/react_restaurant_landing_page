...
const Navbar = () => {
  return (
    <header className='font-poppins m-10 z-100'>
      <nav className='flex items-center justify-between'>
        ...
        <ul className='hidden md:flex items-center gap-8'>
          <li className='border-b-2 border-[#EA0000] px-2'>
            <a href='#'>menu</a>
          </li>
          <li>
            <a href='#'>about us</a>
        ...
        <div className='hidden md:flex items-center gap-4'>
          ...
          <button className='relative'>
            ...
            <div className='flex items-center justify-center w-3 h-3 rounded-full bg-[#EA0000] text-white absolute -top-1 -right-1'><span className='text-[8px]'>2</span></div>
          </button>
          <button>
            <svg
              className='w-5 h-5'
